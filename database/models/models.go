...
type RuleRequest struct {
	...
	TagKey             string `json:"tag_key" validate:"min=1,required"`
	TagValue           string `json:"tag_value" validate:"min=1,required"`
	MetadataField      string `json:"metadata_field" validate:"min=1,required"`
	Keyword            string `json:"keyword" validate:"min=1,required"`
